...
In the sandbox environment, [test BSB codes](/testing/test-bank-accounts) drive predictable outcomes for entries in uploaded files. Use them to test exact matches, close matches, mismatches, missing accounts, and closed accounts.

For status and relationships, see [ABA check](/objects/aba-check).
