...
In non-production, [test BSB codes](/testing/test-bank-accounts) drive predictable outcomes for entries in uploaded files. Use them to test exact matches, close matches, mismatches, missing accounts, and closed accounts.
